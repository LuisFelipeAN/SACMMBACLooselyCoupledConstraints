...
public class ChildrenImplementationConstraint  implements IImplementationConstraintValidator,IDirectTypeInformation,IModelElementImplementationConstraintPainter {
	@Override
